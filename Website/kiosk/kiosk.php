<?php
    ...
    function getBooking($conn, $slotID) {
        // Function to get a random word
        // Accept (connection)conn
        // Return the word as array [id, word]
        //
        $returnUser = "";
        $sql = "SELECT booking_id, slot_id, placed_time, booking_date, start_hour, hour_count, status FROM bookings WHERE slot_id='$slotID' AND (status='0' OR status='1' OR status='4')";
        // User exist
